...
export const siteCopy = {
  ...
  home: {
    ...
    pro: {
      ...
      title: {
        es: "Desbloquea la experiencia Pro",
        en: "Unlock the Pro experience",
      },
      intro: {
    ...
    signup: {
      ...
      placeholder: { es: "tu@sorreo.com", en: "you@example.com" },
      ...
      invalidEmail: { es: "Introduce un correo válido para continuar.", en: "Enter a valid email to continue." },
    },
    faq: {
      ...
      items: [
        {
          question: { es: "¿Cinema Audio Boost ya está disponible?", en: "Is Cinema Audio Boost available now?" },
          answer: { es: "Todatía no. La página es de pre-lanzamiento y está enfocada en generar expectativa antes de publicar la extensión oficialmente.", en: "Not yet. This is a pre-launch page focused on building anticipation before the extension is officially published." }
        },
        {
          question: { es: "¿En qué plataformas funcionará?", en: "Which platforms will it support?" },
          answer: { es: "La experiencia está pensada para Netflix, Disney+, Max, HBO Max, Prime Video, Apple TV+, Paramount+, Movistar Plus+, Claro video y Crunchyroll.", en: "The experience is planned for Netflix, Disney+, Max, HBO Max, Prime Video, Apple TV+, Paramount+, Movistar Plus+, Claro video, and Crunchyroll." }
        },
        {
          question: { es: "¿Necesitaré hardware adicional?", en: "Will I need extra hardware?" },
          answer: { es: "No. La idea es mejorar la experiencia desde Chrome con una extensión ligera y fácil de activar.", en: "No. The goal is to enhance the experience directly in Chrome with a lightweight extension that is easy to activate." }
        },
        {
          question: { es: "¿Habrá una versión Pro?", en: "Will there be a Pro version?" },
          answer: { es: "Sí, está prevista una experiencia Pro con mejora de diálogo inteligente, perfiles personalizados y opciones de boost más avanzadas.", en: "Yes, a Pro experience is planned with smart dialogue enhancement, custom profiles, and more advanced boost controls." }
        }
      ]
    }
  },
  footer: {
    ...
    support: { es: "Soporte", en: "Support" },
    note: { es: "Cinema Audio Boost es una experiencia de pre-lanzamiento para validar interés antes de la publicación oficial.", en: "Cinema Audio Boost is a pre-launch experience built to validate interest ahead of the official release." },
    legal: { es: "No afiliado con plataformas", en: "Not affiliated with streaming platforms" }
  }
} as const;

export const infoPages: Record<InfoPageKey, { eyebrow: LocalizedText; title: LocalizedText; intro: LocalizedText; sections: { title: LocalizedText; body: LocalizedText }[]; actions: Action[] }> = {
  privacy: {
    eyebrow: { es: "Información legal", en: "Legal information" },
    title: { es: "Política de privacidad", en: "Privacy policy" },
    intro: { es: "Esta versión del sitio presenta Cinema Audio Boost como producto en pre-lanzamiento. La página comunica el concepto y ya permite registrarse en la lista de espera.", en: "This version of the site presents Cinema Audio Boost as a pre-launch product. The page communicates the concept and now supports waitlist signups." },
    sections: [
      {
        title: { es: "Estado actual de la captura de datos", en: "Current data collection status" },
        body: { es: "La interfaz de email visible en esta versión envía el correo a una automatización de Google Apps Script para registrar interés temprano en la lista de espera.", en: "The email interface visible in this version sends the address to a Google Apps Script automation to register early waitlist interest." }
      },
      {
        title: { es: "Uso del correo", en: "Email usage" },
        body: { es: "El objetivo del registro es utilizar el correo únicamente para avisos relacionados con el lanzamiento, acceso temprano y novedades del producto.", en: "The intended use of submitted email is limited to launch notices, early access updates, and product news." }
      },
      {
        title: { es: "Plataformas y afiliación", en: "Platforms and affiliation" },
        body: { es: "Cinema Audio Boost no está afiliado con Netflix, Disney+, Max, HBO Max, Prime Video, Apple TV+, Paramount+, Movistar Plus+, Claro video ni Crunchyroll. Los nombres mencionados se usan solo para describir compatibilidad prevista.", en: "Cinema Audio Boost is not affiliated with Netflix, Disney+, Max, HBO Max, Prime Video, Apple TV+, Paramount+, Movistar Plus+, Claro video, or Crunchyroll. Any names referenced are used only to describe intended compatibility." }
      }
    ],
    actions: [
      { href: "/#join-launch", label: { es: "Únete al lanzamiento", en: "Join the launch" }, variant: "primary" },
      {
        href: "/support",
  ...
  support: {
    ...
    intro: { es: "Cinema Audio Boost sigue en fase previa al lanzamiento, así que el canal de soporte aún no está abierto como servicio completo.", en: "Cinema Audio Boost is still in pre-launch, so the support channel is not open yet as a full service." },
    sections: [
      {
        title: { es: "Qué puedes esperar ahora", en: "What you can expect right now" },
        body: { es: "Esta página funciona como referencia temprana para explicar el estado del producto y orientar a quienes quieran seguir de cerca el lanzamiento.", en: "This page acts as an early reference to explain the product status and guide people who want to stay close to launch updates." }
      },
      {
        title: { es: "Soporte cuando el producto salga", en: "Support once the product launches" },
        body: { es: "La versión pública incluirá detalles de contacto, ayuda inicial y una forma clara de reportar dudas sobre compatibilidad o presets.", en: "The public release will include contact details, onboarding help, and a clear way to report compatibility or preset questions." }
      },
      {
        title: { es: "Mejor siguiente paso", en: "Best next step" },
        body: { es: "Si quieres estar entre los primeros en probar Cinema Audio Boost, vuelve a la portada y usa la sección de lanzamiento para registrarte en la lista de espera.", en: "If you want to be among the first to try Cinema Audio Boost, head back to the homepage and use the launch section to join the waitlist." }
      }
    ],
    actions: [
      { href: "/#join-launch", label: { es: "Ir al lanzamiento", en: "Go to launch" }, variant: "primary" },
      {
        href: "/privacy",
