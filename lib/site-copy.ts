...
export const siteCopy = {
  ...
  home: {
    ...
    pro: {
      ...
      features: [
        {
          es: "Mejora de diálogo inteligente",
          en: "Smart dialogue enhancement",
        },
        {
    ...
    signup: {
      ...
      success: {
        es: "Perfecto. Cuando la lista de acceso esté conectada, esta experiencia quedará lista para avisarte primero.",
        en: "Perfect. Once the waitlist is connected, this experience will be ready to notify you first.",
      },
      invalidEmail: {
  ...
  footer: {
    ...
    legal: {
      es: "No afiliado con plataformas",
      en: "Not affiliated with streaming platforms",
    },
  },
} as const;
...
> = {
  privacy: {
    ...
    intro: {
      es: "Esta versión del sitio presenta Cinema Audio Boost como producto en pre-lanzamiento. La página comunica el concepto y prepara la experiencia para futuras integraciones.",
      en: "This version of the site presents Cinema Audio Boost as a pre-launch product. The page communicates the concept and prepares the experience for future integrations.",
    },
    sections: [
      {
        title: {
          es: "Estado actual de la captura de datos",
          en: "Current data collection status",
        },
        body: {
          es: "La interfaz de email visible en esta versión es solo demostrativa. No envía información a un backend ni almacena datos personales en una base persistente.",
          en: "The email interface visible in this version is demonstration-only. It does not submit information to a backend or store personal data in persistent storage.",
        },
      },
      {
        title: {
          es: "Uso futuro del correo",
          en: "Future email usage",
        },
        body: {
          es: "Cuando la integración de la lista de espera esté activa, el objetivo será utilizar el correo únicamente para avisos relacionados con el lanzamiento, acceso temprano y novedades del producto.",
          en: "Once the waitlist integration is active, the intended use of email will be limited to launch notices, early access updates, and product news.",
        },
      },
      {
        title: {
          es: "Plataformas y afiliación",
          en: "Platforms and affiliation",
        },
        body: {
  ...
  support: {
    ...
    sections: [
      {
        title: {
          es: "Qué puedes esperar ahora",
          en: "What you can expect right now",
        },
        body: {
      ...
      {
        title: {
          es: "Soporte cuando el producto salga",
          en: "Support once the product launches",
        },
        body: {
      ...
      },
      {
        ...
        body: {
          es: "Si quieres estar entre los primeros en probar Cinema Audio Boost, vuelve a la portada y usa la sección de lanzamiento para dejar preparada tu intención de registro.",
          en: "If you want to be among the first to try Cinema Audio Boost, head back to the homepage and use the launch section to prepare your early-interest signup.",
        },
      },
    ],
    actions: [
